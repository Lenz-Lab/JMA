...
%% Calculate Coverage Surface Area
        ...
        clear Temp_STL
        Temp_STL = temp_STL;
        clearvars -except pool fldr_name subjects bone_names Data subj_count frame_count g subj_group Temp_STL frame_start overwrite_data TempData save_interval coverage_area_check kine_data_length save_stl_frame save_stl
