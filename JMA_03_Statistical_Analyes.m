...
stats_type = menu('What statistical analysis would you like to perform?','ANOVA or t-Test (Kruskal-Wallis or Rank Sum)','Statistical Parametric Analysis');
...
inp_ui = inputdlg({'Enter the name of the comparison (for figures and results)',...
    ...
    'User Inputs',[1 100],{'','20','45','0','0.05'});
