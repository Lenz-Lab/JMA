...
% FileData = LoadDataFile(FileName)
% This function will load the data from the file named FileName
% FileName = string of file name including type (*.k,*.vtk,etc)
%   File types currently supported:
%   - .xplt
%   - .k
%   - .vtk

% Created by: Rich Lisonbee and Andrew Peterson
